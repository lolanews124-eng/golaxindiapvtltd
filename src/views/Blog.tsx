...
const featuredPost = {
  ...
  title: "Outsource Software Development to India: Complete Guide",
  excerpt:
    "How US, UK and UAE companies should outsource software development to India — costs, timezone overlap, contracts and how to avoid common pitfalls.",
  author: "Vikash Kumar",
  date: "June 5, 2026",
...
const blogPosts = [
  ...
  },
  {
    ...
    excerpt: "Explore practical AI applications for growing businesses, from customer service chatbots to predictive analytics and process automation.",
    author: "Vikash Kumar",
    date: "January 2, 2026",
    readTime: "8 min read",
          ...
          <div className="grid lg:grid-cols-[1fr_400px] xl:grid-cols-[1fr_420px] gap-10 items-start">
            ...
            >
              ...
              <p className="text-xl text-primary-foreground/80 leading-relaxed mb-8">
                Stay ahead with offshore development guides, SEO playbooks and product engineering tips for US, UK, UAE and global buyers.
              </p>
