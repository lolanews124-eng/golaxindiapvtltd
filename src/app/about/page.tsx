...
export const metadata = buildMetadata({
  ...
  description:
    "Since 2014, Golax India has delivered offshore web, SaaS and mobile engineering for US, UK, UAE, Canada and Australia — senior talent, USD billing, NDA/IP ready.",
  keywords:
