...
export const metadata = buildMetadata({
  ...
  description:
    "Book a free discovery call for offshore web, SaaS or mobile development. USD quotes within 24 hours. Email contact@golaxindia.com or WhatsApp +91 9128666005.",
  keywords:
