...
const topLocations = [
  ...
  { name: "Saudi Arabia", href: "/locations/global/saudi-arabia" },
  { name: "New Zealand", href: "/locations/global/new-zealand" },
  { name: "Qatar", href: "/locations/global/qatar" },
];

const popularServices = [
  { name: "Offshore Dev for USA", href: "/services/web-development/global/united-states" },
  { name: "Software for UK", href: "/services/software-development/global/united-kingdom" },
  { name: "Apps for UAE", href: "/services/mobile-app-development/global/united-arab-emirates" },
  { name: "Web Dev for Australia", href: "/services/web-development/global/australia" },
  { name: "New York", href: "/locations/global/united-states/new-york" },
  { name: "London", href: "/locations/global/united-kingdom/london" },
  { name: "Dubai", href: "/locations/global/united-arab-emirates/dubai" },
  { name: "Singapore", href: "/locations/global/singapore/singapore" },
];
          ...
          <div className="container mx-auto px-4 sm:px-6 py-4">
            <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-xs sm:text-sm text-primary-foreground/70">
              <span className="inline-flex items-center gap-1.5">
                ...
                India Delivery HQ · 12+ Countries
              </span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8 xl:gap-12">
            ...
            <div className="lg:col-span-4 space-y-6">
              ...
              <p className="text-primary-foreground/80 text-sm leading-relaxed max-w-sm">
                Offshore engineering partner from India — web development, software, mobile apps & digital marketing for
                startups and enterprises across{" "}
                <strong className="text-primary-foreground font-medium">10 countries</strong>. Delivery HQ: Patna, Bihar.
              </p>
