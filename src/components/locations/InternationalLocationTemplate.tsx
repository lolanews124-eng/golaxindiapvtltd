  ...
  return (
    <Layout>
      ...
      <JsonLd data={{
            ...
            name: `Offshore IT Services for ${location.country}`,
            description,
            url: `${SITE}${pagePath}`,
            serviceType: "Offshore IT Services",
            provider: {
              "@type": "Organization",
            ...
            hasOfferCatalog: {
              ...
              itemListElement: services.map((s) => ({
                ...
                itemOffered: {
                  "@type": "Service",
                  name: `${s.title} for ${location.country} businesses`,
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, i) => (
              <motion.div key={service.slug} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.05 }}>
                <Link
                  href={getServiceCountryHref(service.slug, location.slug)}
